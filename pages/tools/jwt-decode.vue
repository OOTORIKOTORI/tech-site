      ...
      <div class="space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            <button
              v-if="parsedJwt?.header"
              @click="copyToClipboard(formattedHeader)"
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            <button
              v-if="parsedJwt?.payload"
              @click="copyToClipboard(formattedPayload)"
              class="px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded hover:bg-gray-200 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
            >
              コピー
            </button>
